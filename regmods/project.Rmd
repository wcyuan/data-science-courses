...
When you regress miles per gallon by transmission type, the mileage difference is quite pronounced.  
```{r}
...
Red is for manual transmission, green for automatic.
...
##Fig 2. Residuals by tranmission

```{r}
plot(resid(fit)[mtcars$am==F], col='red')
points(resid(fit)[mtcars$am==T], col='green')
```
